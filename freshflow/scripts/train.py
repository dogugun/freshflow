...
model = GradientBoostingRegressor(random_state=42, n_estimators=10, max_depth=1)
model.fit(x, y)

y_pred = model.predict(x)

rmse = mean_squared_error(y, y_pred)**.5
coefficient_of_dermination_cr = r2_score(y, y_pred)
...
pickle.dump(model, open('gbm.json', 'wb'))
